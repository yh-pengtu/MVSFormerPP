...
if __name__ == '__main__':
    ...
    for idx, sec in enumerate(data_bar):
        ...
        with open(os.path.join(sec, 'mvs/back', 'pair.txt'), 'w') as f:
            f.write('%d\n' % len(images))
        ...
        for i in range(num_images):
            ...
            if args.convert_format:
                ...
                shutil.copyfile(os.path.join(image_dir, 'back', images[v].name), os.path.join(renamed_dir, '%08d.jpg' % i))
